...
import nanonets
from api.multi_label_classification_train_api import MultiLabelClassificationTrainApi  # noqa: E501
from nanonets.rest import ApiException


class TestMultiLabelClassificationTrainApi(unittest.TestCase):
    """MultiLabelClassificationTrainApi unit test stubs"""

    def setUp(self):
        self.api = api.multi_label_classification_train_api.MultiLabelClassificationTrainApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_multi_label_classification_model_train_by_model_id_post(self):
        """Test case for multi_label_classification_model_train_by_model_id_post
