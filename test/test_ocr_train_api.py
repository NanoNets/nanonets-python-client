...
import nanonets
from api.ocr_train_api import OCRTrainApi  # noqa: E501
from nanonets.rest import ApiException


class TestOCRTrainApi(unittest.TestCase):
    """OCRTrainApi unit test stubs"""

    def setUp(self):
        self.api = api.ocr_train_api.OCRTrainApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_o_cr_model_train_by_model_id_post(self):
        """Test case for o_cr_model_train_by_model_id_post
