...
class MultiLabelClassificationTrainApi(object):
    ...
    def multi_label_classification_model_train_by_model_id_post(self, model_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.multi_label_classification_model_train_by_model_id_post(model_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.multi_label_classification_model_train_by_model_id_post_with_http_info(model_id, **kwargs)  # noqa: E501
        else:
            (data) = self.multi_label_classification_model_train_by_model_id_post_with_http_info(model_id, **kwargs)  # noqa: E501
            return data

    def multi_label_classification_model_train_by_model_id_post_with_http_info(self, model_id, **kwargs):  # noqa: E501
        """Train Model  # noqa: E501

        You can use this endpoint to train a model after uploading images for each category. You can use the same endpoint to retrain a model after uploading more images to improve the model.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.multi_label_classification_model_train_by_model_id_post_with_http_info(model_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method multi_label_classification_model_train_by_model_id_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('model_id' not in params or
            ...
            raise ValueError("Missing the required parameter `model_id` when calling `multi_label_classification_model_train_by_model_id_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/MultiLabelClassification/Model/{model_id}/Train/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
