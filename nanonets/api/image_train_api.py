...
class ImageTrainApi(object):
    ...
    def image_categorization_train_post(self, model_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.image_categorization_train_post(model_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.image_categorization_train_post_with_http_info(model_id, **kwargs)  # noqa: E501
        else:
            (data) = self.image_categorization_train_post_with_http_info(model_id, **kwargs)  # noqa: E501
            return data

    def image_categorization_train_post_with_http_info(self, model_id, **kwargs):  # noqa: E501
        """Train Model  # noqa: E501

        You can use this endpoint to train a model after uploading images for each category. You can use the same endpoint to retrain a model after uploading more images to improve the model.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.image_categorization_train_post_with_http_info(model_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method image_categorization_train_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('model_id' not in params or
            ...
            raise ValueError("Missing the required parameter `model_id` when calling `image_categorization_train_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ImageCategorization/Train/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
